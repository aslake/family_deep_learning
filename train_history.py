...
def plot_train_history(modell=config.model):
    ...
    plt.plot(np.arange(0, epochs), history["accuracy"], label="model accuracy", color="red", zorder=10, linewidth=1)
    plt.plot(np.arange(0, epochs), history["loss"], label="training loss", color="blue", zorder=9, linewidth=1)
    plt.plot(np.arange(0, epochs), history["val_accuracy"], label="validation accuracy", color="red", zorder=1, linewidth=1, alpha= 0.3)
    plt.plot(np.arange(0, epochs), history["val_loss"], label="validation loss", color="blue", zorder=2, linewidth=1, alpha= 0.3)
